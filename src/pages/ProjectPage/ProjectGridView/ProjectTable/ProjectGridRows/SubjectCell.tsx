...
export function SubjectCell({
  ...
  return (
    <div className="flex w-full min-w-0 items-center gap-[4px] overflow-hidden">
      {depth > 0 ? (
        <CornerDownRight
          aria-hidden
      ...
      <button
        className={cn(
          "block min-w-0 flex-1 cursor-pointer overflow-hidden",
          "text-ellipsis whitespace-nowrap border-0 bg-transparent p-0",
